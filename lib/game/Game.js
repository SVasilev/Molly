game = new Phaser.Game(800, 680, Phaser.CANVAS, 'phaser-example', { preload: preload, create: create, update: update, render: render });
...
function create() {
    ...
    game.objects["spikes"].forEach(function(element) {
    	game.player.sprite.body.createBodyCallback(element, func, game);
	});
