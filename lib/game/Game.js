...
function preload() {
	game.load.tilemap('map', '../../tilemaps/blqblq.json', null, Phaser.Tilemap.TILED_JSON);
...
function create() {
    var json = presentationUtils.getJSONdata("tilemaps/blqblq.json");
    ...
    player = game.add.sprite(450, JSONlevels[0].height * 32 - 2100, 'kurt');
